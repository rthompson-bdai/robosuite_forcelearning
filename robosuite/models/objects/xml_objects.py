...
class SmallSquareNutObject(MujocoXMLObject):
    """
    Square nut object (used in NutAssembly)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/small-square-nut.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class SmallRoundNutObject(MujocoXMLObject):
    """
    Round nut (used in NutAssembly)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/small-round-nut.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
