...
from robosuite.models.objects import SmallRoundNutObject, SmallSquareNutObject
from robosuite.models.tasks import ManipulationTask
from robosuite.utils.observables import Observable, sensor
from robosuite.utils.placement_samplers import SequentialCompositeSampler, UniformRandomSampler


class SmallNutAssembly(SingleArmEnv):
    """
    ...
    def _load_model(self):
        ...
        for i, (nut_cls, nut_name) in enumerate(
            zip(
                (SmallSquareNutObject, SmallRoundNutObject),
                nut_names,
            )
        ):
...
class SmallNutAssemblySingle(SmallNutAssembly):
    """
...
class SmallNutAssemblySquare(SmallNutAssembly):
    """
...
class SmallNutAssemblyRound(SmallNutAssembly):
    """
